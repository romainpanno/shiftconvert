    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">{t('convert.title')} {t('category.fonts')}</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">{t('category.fonts.desc')}</p>
        </div>
        ...
        {files.length > 0 && (
          <div className="flex flex-wrap gap-3">
            ...
            <button
              onClick={clearFiles}
              className="btn btn-secondary flex items-center gap-2 text-red-600 dark:text-red-400"
            >
...
function FontFileCard({
  ...
  return (
    <div className="card p-4">
      <div className="flex items-center gap-3">
        <div className="w-10 h-10 bg-orange-100 dark:bg-orange-900/30 rounded-lg flex items-center justify-center text-orange-600 dark:text-orange-400 font-bold text-xs">
                  ...
                  {categoryFields.map(({ key, label }) => (
                    <div key={key}>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-1.5 text-sm border border-gray-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                        placeholder={label}
                      />
                    </div>
                  ))}
