  ...
  if (!categoryInfo || !converterConfig) {
    return (
      <div className="py-12 px-4 text-center">
        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">{t('convert.categoryNotFound')}</h1>
    ...
    <div className="py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">{t(categoryInfo.descriptionKey)}</p>
          {categoryInfo.limitationsKey && (
            <div className="mt-3 flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-lg text-sm text-amber-800 dark:text-amber-300">
              ...
              <>
                ...
                {unavailableFormats.map((format) => (
                  <button
                    ...
                    className="px-4 py-2.5 rounded-xl text-sm font-medium bg-gray-50 dark:bg-gray-800 text-gray-300 dark:text-gray-600 cursor-not-allowed line-through"
                  >
                    {format.toUpperCase()}
                  </button>
                ))}
